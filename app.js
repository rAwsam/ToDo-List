...
app.post("/list", function(req, res) {
    ...
    if (listName != day) { // enters into users endpoints
        const newItem = {
            _id: userId,
            item: req.body.point
        };
    ...
    } else { // enters into default endpoints
...
app.post("/del", (req, res) => {
    ...
    if (userName == day) { // enters into default endpoints for deletion
        dailyData.deleteOne({
            _id: itemNo
        }, (err) => {
            if (!err) {
    ...
    } else { // enters into users endpoints for deletion
